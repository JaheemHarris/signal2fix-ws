package com.itu.signal2fixWS.filter;
...
public class CustomJwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        if (request.getServletPath().equals("/api/v1/login") || request.getServletPath().equals("/api/v1/users/register") || request.getServletPath().equals("/api/v1/signalements/image")) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        excludedUrls.add("/api/v1/users/register");
